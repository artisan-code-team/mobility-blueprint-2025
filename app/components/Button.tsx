...
const variantStyles = {
  solid: {
    slate:
      'bg-slate-800 text-white hover:bg-slate-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-800 active:bg-slate-800 active:text-white/80 disabled:opacity-30 disabled:hover:bg-slate-800',
    blue: 'bg-blue-900 text-white hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-900 active:bg-blue-700 active:text-white/80 disabled:opacity-30 disabled:hover:bg-blue-900',
    white:
      'bg-white text-blue-900 hover:text-blue-700 focus-visible:text-blue-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white active:bg-blue-50 active:text-blue-900/80 disabled:opacity-40 disabled:hover:text-blue-900',
  },
  outline: {
    slate:
